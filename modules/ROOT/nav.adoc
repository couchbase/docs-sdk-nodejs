...
* xref:hello-world:start-using-ottoman.adoc[Start Using the Ottoman ODM]
...
.Project Docs
* xref:project-docs:sdk-release-notes.adoc#version-3-2-4-17-december-2021[Release Notes]
* xref:project-docs:ottoman-release-notes.adoc#version-2-2-1-22-june-2022[Ottoman Release Notes]
