...
From Couchbase Server 5.0, you will need to authenticate the user, rather than against the bucket, as part of xref:5.1@server:security:security-authorization.adoc[Role-Based Access Control].
