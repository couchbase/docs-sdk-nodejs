...
From Couchbase Server 5.0, you will need to authenticate the user, rather than against the bucket, as part of xref:6.0@server:security:security-authorization.adoc[Role-Based Access Control].
