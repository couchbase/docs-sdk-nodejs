...
For example, to install version 2.5.1:
...
== Version 2.6.12 (5 May 2020)

Version 2.6.12 is a minor maintenance release of the 2.6 series.
...
http://docs.couchbase.com/sdk-api/couchbase-node-client-2.6.12/[API Reference]

=== Fixed Issues

* http://issues.couchbase.com/browse/JSCBC-726[JSCBC-726]:
Marked diagnostics method as committed.
* http://issues.couchbase.com/browse/JSCBC-721[JSCBC-721]:
Added option to disable DNS SRV.
* Updated all dependencies to latest versions.



== Version 2.6.11 (20 March 2020)

Version 2.6.11 is a minor maintenance release of the 2.6 series.
...
http://docs.couchbase.com/sdk-api/couchbase-node-client-2.6.11/[API Reference]

=== Fixed Issues

* Updated all dependencies to latest versions.
* Updated to libcouchbase 2.10.6.
* Adjusted prebuilt binaries to match currently supported Node.js versions.


== Version 2.6.10 (December 19 2019)

Version 2.6.10 is a minor maintenance release of the 2.6 series.

[source,bash]
----
$ npm install couchbase@2.6.10
----

http://docs.couchbase.com/sdk-api/couchbase-node-client-2.6.10/[API Reference]

=== Fixed Issues

* http://issues.couchbase.com/browse/JSCBC-630[JSCBC-630]:
Corrected issue with decoding invalid JSON.
* http://issues.couchbase.com/browse/JSCBC-631[JSCBC-631]:
Added support for building with Node.js v13.
* Various minor changes.
* Various dependency updates and security audit fixes.

=== Known Issues

* libcouchbase version is incorrectly reported as 2.10.4.

== Version 2.6.9 (November 8 2019)

Version 2.6.9 is a minor maintenance release of the 2.6 series.

[source,bash]
----
$ npm install couchbase@2.6.9
----

http://docs.couchbase.com/sdk-api/couchbase-node-client-2.6.9/[API Reference]

=== Fixed Issues

* http://issues.couchbase.com/browse/JSCBC-625[JSCBC-625]:
Fixed inability to ping the analytics service.
* http://issues.couchbase.com/browse/JSCBC-624[JSCBC-624]:
Updated to latest version of libcouchbase (2.10.5)
...
* https://issues.couchbase.com/browse/JSCBC-390[JSCBC-390]: Added method for getting diagnostic info
from the client.
