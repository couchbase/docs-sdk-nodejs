...
Refer to the xref:4.5@server:getting-started:installing.adoc[quick installation guide] for server installation instructions.
...
* An API reference is generated for each release and can be found at http://docs.couchbase.com/sdk-api/couchbase-node-client-2.2.1[^]
