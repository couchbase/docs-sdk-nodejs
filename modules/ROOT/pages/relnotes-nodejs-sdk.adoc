...
Fix configuration changes failing before connect.
* http://issues.couchbase.com/browse/JSCBC-528[JSCBC-528]:
Fixed inline documentation for bucket querying.
* http://issues.couchbase.com/browse/JSCBC-527[JSCBC-527]:
Improve error message for unknown HTTP errors. 
...
End traces at correct point for FTS and N1QL. 
* http://issues.couchbase.com/browse/JSCBC-540[JSCBC-540]:
Fixed Winston logging warning. 
* http://issues.couchbase.com/browse/JSCBC-529[JSCBC-529]:
Added insert/upsert docs in mutateIn method. 
