...
* http://issues.couchbase.com/browse/JSCBC-342[JSCBC-3]http://issues.couchbase.com/browse/JSCBC-395[95]:
Fixed issue causing buildDeferredIndexes to error.
* http://issues.couchbase.com/browse/JSCBC-365[JSCBC-3]http://issues.couchbase.com/browse/JSCBC-396[96]:
Fixed issue where getIndexes returned unexpected indexes.
* http://issues.couchbase.com/browse/JSCBC-381[JSCBC-38]http://issues.couchbase.com/browse/JSCBC-384[4]:
Implemented experimental 5.0.0 user management API.
* http://issues.couchbase.com/browse/JSCBC-382[JSCBC-3]http://issues.couchbase.com/browse/JSCBC-386[86]:
...
* http://issues.couchbase.com/browse/JSCBC-339[JSCBC-3]http://issues.couchbase.com/browse/JSCBC-340[40]:
