...
Version 2.6.4 is a minor maintenance release of the 2.6 series.  This release
is a rebuild of the 2.6.3 client including a builder fix to correct an 
incompatibility with older RHEL systems.
...
* Due to a new build system introduced in the 2.6.1 timeframe, there
  is a known incompatibility when using the prebuilds from this release
  with RHEL7, 2.6.4 should be used instead.
