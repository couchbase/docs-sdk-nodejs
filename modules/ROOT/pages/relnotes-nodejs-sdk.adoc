...
2.6 series. It adds support for the upcoming Couchbase Server 6.0.
...
Added expanded support for Couchbase Analytics.
* http://issues.couchbase.com/browse/JSCBC-508[JSCBC-508]:
Added helper for specifying custom N1QL query options.
