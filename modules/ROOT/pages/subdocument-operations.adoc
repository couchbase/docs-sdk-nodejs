...
The _path_ follows N1QL syntax (see https://developer.couchbase.com/documentation/server/current/sdk/subdocument-operations.html#story-h2-12[below^], and xref:4.6@server:n1ql:n1ql-intro/queriesandresults.adoc[N1QL Queries and Results]).
