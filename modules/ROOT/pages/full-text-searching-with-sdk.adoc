...
* A location, specified as a longitude-latitude coordinate pair; and a distance, with units -- (in|ft|yd|mi|mm|cm|m|km|nm) where nm is nautical miles.
...
​
// lon, lat, distance (with units, eg 100mi, 20km.
