...
https://ottomanjs.com/#introduction[Ottoman.js] version 2.3.0 and above are compatible with xref:3.2@nodejs-sdk:hello-world:start-using-ottoman.adoc[Couchbase Node.js SDK 4.2.0] and above.
