...
async function go() {
  ...
  ftsMatchWord('five-star').then((result) => console.log(result))
  ...
  ftsMatchPhrase('10-minute walk from the').then((result) =>
    console.log(result)
  )
  ...
  ftsBreweryUpdatedByDateRange('2010-11-10', '2010-11-20').then((result) =>
    console.log(result)
  )
  ...
  ftsConjunction().then((result) => console.log(result))
  ...
  ftsDisjunction().then((result) => console.log(result))
  // end::search-query-disjuncts[]

  // tag::handle-hits[]
  ftsDisjunction().then((result) => {
