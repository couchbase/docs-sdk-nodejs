...
The full list of recognized parameters is documented in the https://docs.couchbase.com/sdk-api/couchbase-node-client-4.1.3/interfaces/ConnectOptions.html[API reference].
