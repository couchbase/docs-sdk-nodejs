...
[source,javascript]
----
include::devguide:example$nodejs/auth.js[tag=rbac-auth,indent=0]
----


For a non-local cluster, substitute the `localhost` line with:
...
[source,javascript]
----
include::devguide:example$nodejs/auth.js[tag=many-hosts,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/auth.js[tag=alt-addresses,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/auth.js[tag=alt-addresses-external,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/auth.js[tag=tls-cacert,indent=0]
----
