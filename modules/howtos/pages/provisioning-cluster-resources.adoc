...
[source,javascript]
----
include::example$collection-manager.js[tags=create-collection;!pending-JSCBC-858,indent=0]
----
...
[source,javascript]
----
include::example$collection-manager.js[tags=drop-collection;!pending-JSCBC-858,indent=0]

include::example$collection-manager.js[tags=drop-scope;!pending-JSCBC-858,indent=0]
----
