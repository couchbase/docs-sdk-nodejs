...
This is a xref:6.5@server:developer-preview:collections/collections-overview.adoc[Developer Preview feature],
see: https://docs.couchbase.com/sdk-api/couchbase-node-client-3.0.5/CollectionManager.html.
