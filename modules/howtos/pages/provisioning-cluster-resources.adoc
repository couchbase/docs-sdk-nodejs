...
[source,javascript]
----
include::devguide:example$nodejs/provisioning.js[tag=create-bucketmgr,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning.js[tag=create-bucket,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning.js[tag=update-bucket,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning.js[tag=remove-bucket,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning.js[tag=flush-bucket,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/collection-manager.js[tag=create-collection-manager,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/collection-manager.js[tag=create-scope,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/collection-manager.js[tags=create-collection,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/collection-manager.js[tags=drop-collection,indent=0]

include::devguide:example$nodejs/collection-manager.js[tags=drop-scope,indent=0]
...
[source,javascript]
----
include::devguide:example$nodejs/collection-manager.js[tag=scopeAdmin,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/query-index-manager.js[tag=creating-index-mgr,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/query-index-manager.js[tag=primary,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/query-index-manager.js[tag=secondary,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/query-index-manager.js[tag=defer-indexes,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/query-index-manager.js[tag=drop-primary-or-secondary-index,indent=0]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning-resources-views.js[tag=creating-index-mgr]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning-resources-views.js[tag=create-view]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning-resources-views.js[tag=get-view]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning-resources-views.js[tag=publish-view]
----
...
[source,javascript]
----
include::devguide:example$nodejs/provisioning-resources-views.js[tag=drop-view]
----
