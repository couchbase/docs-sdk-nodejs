...
As covered xref:concurrent-async-apis.adoc[here], the Node.js SDK ships with two different APIs, allowing you to structure your application the way you want.
