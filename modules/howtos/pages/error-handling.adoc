...
The Node.js SDK works directly with the built in exception handling available in Javascript.  This enables you to catch, interogate and handle or
log them and continue.  Depending on the type of the exception you catch, there are a number of properties which will be available to you.

[source,javascript,indent=0]
----
include::devguide:example$nodejs/error-handling.js[tag=catch]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/error-handling.js[tag=notfound]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/error-handling.js[tag=exists]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/error-handling.js[tag=cas]
----
...
So `TimeoutError` is one ambiguous error, another is `DurabilityAmbiguousError`, which can returned when performing a durable operation.
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/error-handling.js[tag=insert]
----
...
A N1QL query either returns results or will throw an error with a `QueryErrorContext`, like so:

[source,javascript,indent=0]
----
include::devguide:example$nodejs/error-handling.js[tag=query]
----
