...
Use xref:{version-server}@server:tools:cbq-shell.adoc[cbq], our interactive Query shell.
...
// TODO: improving this and/or adding server/{version-server}/tools/query-workbench.html
...
From version 3.0.7 of the Node.js SDK, it is possible to query off the xref:7.0@server:learn:data/scopes-and-collections.adoc[`Scope` level] _with the Couchbase Server release, 7.0_,
