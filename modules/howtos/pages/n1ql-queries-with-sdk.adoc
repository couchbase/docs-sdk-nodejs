...
Before you get started you may wish to check out the xref:7.0@server:n1ql:n1ql-language-reference/index.adoc[N1QL intro page], or just dive in with a query against our travel-sample data set.
...
Use xref:7.0@server:tools:cbq-shell.adoc[cbq], our interactive Query shell.
...
// TODO: improving this and/or adding server/7.0/tools/query-workbench.html
...
The xref:7.0@server:n1ql:n1ql-language-reference/index.adoc[N1QL Language Reference] introduces up a complete guide to the N1QL language, including all of the latest additions.
