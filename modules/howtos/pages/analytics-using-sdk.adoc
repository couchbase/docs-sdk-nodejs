...
----
include::devguide:example$nodejs/analytics.js[tag=basic-query]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/analytics.js[tag=simple-query]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/analytics.js[tag=posparam-query]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/analytics.js[tag=namedparam-query]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/analytics.js[tag=priority-query]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/analytics.js[tag=handle-rows]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/analytics.js[tag=handle-meta]
----
...
[source,javascript]
----
include::devguide:example$nodejs/analytics.js[tag=handle-collection]
----
////
...
[source,javascript]
----
include::devguide:example$nodejs/analytics.js[tag=handle-scope]
----
////
