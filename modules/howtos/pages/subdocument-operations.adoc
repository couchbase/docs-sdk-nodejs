...
----
include::devguide:example$nodejs/subdoc.js[tag=lookup-get]
----

.Check existence of sub-document path
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=lookup-exists]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=lookup-multi]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-upsert]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-insert]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-multi]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-store-semantics]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-arrayappend]
----

[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-arrayprepend]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-tl-arrayappend]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-tl-arrayappend-multi]
----

.Add single array as element to existing array
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-tl-arrayappend-array]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-tl-arrayappend-multibad]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-createpaths]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-arrayaddunique]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-arrayinsert]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-increment]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-decrement]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-upsert-parents]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=lookup-in-any-replica]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=lookup-in-all-replicas]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-cas]
----

[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-cas-noconflict]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=cas]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-persistto]
----
...
[source,javascript,indent=0]
----
include::devguide:example$nodejs/subdoc.js[tag=mutate-durability]
----
////
