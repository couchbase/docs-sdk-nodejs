...
[source,javascript]
----
collection.mutateIn('customer123', [
...
[source,javascript]
----
var result = collection.mutateIn('customer123', [
...
var result = collection.mutateIn('player432', [
...
[source,javascript]
----
collection.mutateIn('couchbase123', [
