...
Couchbase's xref:2.6@nodejs-sdk:concept-docs:durability-replication-failure-considerations.adoc[traditional durability], using `persistTo` and `replicateTo`, is still available, particuarly for talking to Couchbase Server 6.0 and earlier:
