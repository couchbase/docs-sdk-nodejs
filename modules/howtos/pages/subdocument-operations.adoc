...
Couchbase's xref:2.7@nodejs-sdk::durability.adoc[traditional durability], using `persistTo` and `replicateTo`, is still available, particuarly for talking to Couchbase Server 6.0 and earlier:
