...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=intro]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=config]

// TODO: this partial needs to change a bit, owing to library references.
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=creating]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=lambda-ctx]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=mechanics]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=query-perf]

include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=query-single]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=example]
...
//  Error Handling
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=error]



//  txnfailed
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=txnfailed]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=txnfailed1]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=cleanup]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=custom-metadata-1]
...
include::7.1@sdk:shared:partial$acid-transactions.adoc[tag=further]