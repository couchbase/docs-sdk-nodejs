...
To configure threshold logging, swap out the default tracer (ThresholdLoggingTracer) with your own instance of ThresholdLoggingTracer with 
the custom options you wish to use (via the ThresholdLoggingTracerOptions).
