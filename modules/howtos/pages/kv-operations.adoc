...
[source,javascript]
----
include::example$old-kv-operations.js[tag=insert,indent=0]
----
...
[source,javascript]
----
include::example$old-kv-operations.js[tag=insertwithoptions,indent=0]
----
...
[source,javascript]
----
include::example$old-kv-operations.js[tag=replace,indent=0]
----
...
[source,javascript]
----
include::example$old-kv-operations.js[tag=durability,indent=0]
----
...
[source,javascript]
----
include::example$old-kv-operations.js[tag=newdurability,indent=0]
----
...
[source,javascript]
----
include::example$old-kv-operations.js[tag=get,indent=0]
----
...
[source,javascript]
----
include::example$old-kv-operations.js[tag=getwithoptions,indent=0]
----
...
[source,javascript]
----
include::example$old-kv-operations.js[tag=remove,indent=0]
----
