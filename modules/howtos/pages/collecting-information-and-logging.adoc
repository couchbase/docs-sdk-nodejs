...
IMPORTANT:  Logging on the Node.js side is still separate from the underlying {cpp} core logging.  Integration with the {cpp} core logging is planned for a future release.
