...
That is, a cluster certificate has been created and installed on the server, a client certificate has been created, and it is stored on the client machine.

[source,javascript]
----
include::example$auth.js[tag=cert-auth,indent=0]
----
