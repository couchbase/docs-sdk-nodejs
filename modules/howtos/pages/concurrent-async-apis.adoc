...
:page-aliases: ROOT:async-programming,ROOT:batching-operations,multiple-apis,ROOT:bulk-operations
...
// You have now completed the Node.js 'Choose Your own API Adventure'.
// Please insert a quarter to play again.
