...
== Version 2.5.8 (9 July 2026)

Version 2.5.8 is a patch release of the Ottoman ODM.
This release updates vulnurable dependencies.
...
== Version 2.5.7 (24 June 2026)

Version 2.5.7 is a patch release of the Ottoman ODM.
This release bumps the underlying Couchbase SDK to `v4.7.1`, and updates vulnurable dependencies.
...
This release bumps the underlying Couchbase SDK to `v4.6.0`.
...
* Preserve null/undefined values instead of casting to unix timestamp in https://github.com/couchbaselabs/node-ottoman/pull/804[#804]
* Bumped underlying Couchbase SDK version to latest.


== Version 2.5.2 (16 May 2025)

Version 2.5.2 is a patch release of the Ottoman ODM.
This release bumps the underlying Couchbase SDK to `v4.4.6`.
