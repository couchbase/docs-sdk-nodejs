...
At the time of writing, only the 3.2 Node.js SDK is compatible with https://ottomanjs.com/#introduction[version 2.0 of the Ottoman ODM].

NOTE: The 4.2 Node.js SDK is not tested against Ottoman.
