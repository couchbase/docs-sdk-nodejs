...
const collection=bucket.collection('my-collection');
var getResult = collection.get("airline_1191",{timeout:3},(err, res) => {
...
const bucket = cluster.bucket("travel-sample", "");
const collection=bucket.collection('my-collection');
var getResult = collection.getReplica("airline_1191",{timeout:3},(err, res) => {
        console.log("res: "+JSON.stringify(res));
    });
----
