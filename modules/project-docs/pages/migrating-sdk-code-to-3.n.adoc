...
:description: The SDK API 3 (used in Node.js SDK 3.x and 4.x)  breaks the previous SDK API 2 APIs (used in Node.js SDK 2.x) in order to provide a number of improvements. \
...
Though the API still matches the SDK API 3._x_ spec, we have increased the major version to reflect the importance of this implementation change, as per https://semver.org/[semantic versioning].
