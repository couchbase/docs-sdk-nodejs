...
Please see the 
//xref:howtos:authentication.adoc[documentation on certificate-based authentication] 
xref:java-sdk::howtos:sdk-authentication.adoc[documentation on certificate-based authentication] 
for detailed information on how to configure this properly.
