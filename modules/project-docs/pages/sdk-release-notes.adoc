...
For release notes, download links, and installation methods for 2.6 and earlier releases of the Couchbase Node.js Client, please see the xref:2.6@c-sdk::sdk-release-notes.adoc[2.x Node.js Release Notes & Download Archive].
