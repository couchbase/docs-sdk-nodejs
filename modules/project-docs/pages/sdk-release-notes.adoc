...
For example, to install version 4.5.0:
...
bucket_not_found during bootstrap triggers DNS-SRV refresh loop (https://github.com/couchbase/couchbase-cxx-client/pull/897[#897])
