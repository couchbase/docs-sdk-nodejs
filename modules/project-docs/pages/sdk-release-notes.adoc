...
For example, to install version 4.4.6:
...
Add custom log callback functionality (https://github.com/couchbase/couchbase-cxx-client/pull/743[#743])

https://jira.issues.couchbase.com/browse/CXXCBC-626[CXXCBC-626]:
Application Service Telemetry (https://github.com/couchbase/couchbase-cxx-client/pull/712[#712], https://github.com/couchbase/couchbase-cxx-client/pull/719[#719], https://github.com/couchbase/couchbase-cxx-client/pull/739[#739], https://github.com/couchbase/couchbase-cxx-client/pull/750[#750])

https://jira.issues.couchbase.com/browse/CXXCBC-654[CXXCBC-654]:
Add num_vbuckets to bucket_settings (https://github.com/couchbase/couchbase-cxx-client/pull/746[#746])s

https://jira.issues.couchbase.com/browse/CXXCBC-665[CXXCBC-665]:
Always return partial results for *_all_replica operations if some get_replica requests succeeded (https://github.com/couchbase/couchbase-cxx-client/pull/742[#742])

https://jira.issues.couchbase.com/browse/CXXCBC-672[CXXCBC-672]:
Add add_named_parameter and add_positional_parameter to query/analytics options (https://github.com/couchbase/couchbase-cxx-client/pull/762[#762])

https://jira.issues.couchbase.com/browse/CXXCBC-684[CXXCBC-684]:
Allow setting both named and positional parameters for queries (https://github.com/couchbase/couchbase-cxx-client/pull/759[#759])

===== Fixes and Enhancements

https://jira.issues.couchbase.com/browse/CXXCBC-646[CXXCBC-646]:
Do not copy configuration when the operation depends on it (https://github.com/couchbase/couchbase-cxx-client/pull/715[#715], https://github.com/couchbase/couchbase-cxx-client/pull/720[#720])

https://jira.issues.couchbase.com/browse/CXXCBC-657[CXXCBC-657]:
Raise InvalidArgument error if empty subdoc specs (https://github.com/couchbase/couchbase-cxx-client/pull/727[#727]. For subdoc operations, if no specs are provided raise and `invalid_argument` error instead of crashing on an assert.

https://jira.issues.couchbase.com/browse/CXXCBC-660[CXXCBC-660]:
Fix potential race condition in the logger (https://github.com/couchbase/couchbase-cxx-client/pull/722[#722])
...
Implement get_multi_* APIs for transactions (https://github.com/couchbase/couchbase-cxx-client/pull/761[#761], https://github.com/couchbase/couchbase-cxx-client/pull/764[#764], https://github.com/couchbase/couchbase-cxx-client/pull/766[#766])

https://jira.issues.couchbase.com/browse/CXXCBC-649[CXXCBC-649]:
Implement ExtReplaceBodyWithXattr (https://github.com/couchbase/couchbase-cxx-client/pull/752[#752])

https://jira.issues.couchbase.com/browse/CXXCBC-681[CXXCBC-681]:
Do not store entire transaction_get_result in staged mutations (https://github.com/couchbase/couchbase-cxx-client/pull/757[#757])

https://jira.issues.couchbase.com/browse/CXXCBC-682[CXXCBC-682]:
Transaction replace/insert result should include post-op content (https://github.com/couchbase/couchbase-cxx-client/pull/756[#756])

https://jira.issues.couchbase.com/browse/CXXCBC-683[CXXCBC-683]:
Transactions replace: use CAS from given TransactionsGetResult when document is a staged insert (https://github.com/couchbase/couchbase-cxx-client/pull/763[#763])
