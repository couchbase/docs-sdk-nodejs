...
For example, to install version 4.6.0:
...
=== Version 4.7.0 (31 March 2026)

Version 4.7.0 is a minor release of the fourth generation Node.js SDK, bringing a number of improvements.
Most notably the 4.7.0 release adds observability support (with the ability to integrate with OpenTelemetry).

[source,bash]
----
$ npm install couchbase@4.7.0
----

*API Docs:* http://docs.couchbase.com/sdk-api/couchbase-node-client-4.7.0/


==== Enhancements

* https://jira.issues.couchbase.com/browse/JSCBC-1040[JSCBC-1040],
https://jira.issues.couchbase.com/browse/JSCBC-1373[JSCBC-1373],
https://jira.issues.couchbase.com/browse/JSCBC-1374[JSCBC-1374],
https://jira.issues.couchbase.com/browse/JSCBC-1375[JSCBC-1375],
https://jira.issues.couchbase.com/browse/JSCBC-1381[JSCBC-1381],
https://jira.issues.couchbase.com/browse/JSCBC-1385[JSCBC-1385],
https://jira.issues.couchbase.com/browse/JSCBC-1386[JSCBC-1386],
https://jira.issues.couchbase.com/browse/JSCBC-1388[JSCBC-1388]:
Added Observability Support. SDK natively supports Tracing, Metrics and OTel Integration

* https://jira.issues.couchbase.com/browse/JSCBC-1345[JSCBC-1345]:
Upgraded ESLint to version that uses v9.0 major release

* https://jira.issues.couchbase.com/browse/JSCBC-1364[JSCBC-1364]:
Updated OrphanReporterConfig.enableReporting to set C++ core orphan config

* https://jira.issues.couchbase.com/browse/JSCBC-1365[JSCBC-1365]:
Added support mTLS Certs Refresh (without restart)

* https://jira.issues.couchbase.com/browse/JSCBC-1366[JSCBC-1366]:
Added support JWT based authentication in Operational SDKs

* https://jira.issues.couchbase.com/browse/JSCBC-1377[JSCBC-1377]:
Removed `Transcoder` class from bindings

* https://jira.issues.couchbase.com/browse/JSCBC-1380[JSCBC-1380]:
Deprecated support for MapReduce Views Since Server Deprecated

* https://jira.issues.couchbase.com/browse/JSCBC-1382[JSCBC-1382]:
Improved build scripts

* https://jira.issues.couchbase.com/browse/JSCBC-1384[JSCBC-1384]:
Added Logging Interface

* https://jira.issues.couchbase.com/browse/JSCBC-1387[JSCBC-1387]:
Upgraded cmake-js to version that uses v8.0 major release

==== Fixes

* https://jira.issues.couchbase.com/browse/JSCBC-1367[JSCBC-1367]:
Fixed `createBucket` and `updateBucket` are sending unspecified fields to server

* https://jira.issues.couchbase.com/browse/JSCBC-1368[JSCBC-1368]:
Fixed scope query and analytics query to surrounding bucket/scope name with backticks

* https://jira.issues.couchbase.com/browse/JSCBC-1369[JSCBC-1369]:
Fixed `mutateIn` `replace` with empty path to do a full doc replace

* https://jira.issues.couchbase.com/browse/JSCBC-1372[JSCBC-1372]:
Fixed bucket management `getBucket` test for against server 8.0
...
* https://jira.issues.couchbase.com/browse/CXXCBC-732[CXXCBC-732]: Fixed memory leaks in concurrent fixed queue reporting.
* https://jira.issues.couchbase.com/browse/CXXCBC-739[CXXCBC-739]: **mTLS Certificate Refresh** - Added support for refreshing TLS certificates without restarting the application. Certificates can now be updated via `cluster::update_credentials()` and new TLS sessions will use the updated certificates.
* https://jira.issues.couchbase.com/browse/CXXCBC-740[CXXCBC-740]: **JWT Authentication** - Added JWT-based authentication support via jwt_authenticator. The authenticator can refresh tokens automatically and supports reauthentication when tokens become stale.
* https://jira.issues.couchbase.com/browse/CXXCBC-745[CXXCBC-745]: **Lazy Connections Mode** - Added new `enable_lazy_connections` option that delays opening KV connections until the first operation is executed, reducing initial connection overhead.
* https://jira.issues.couchbase.com/browse/CXXCBC-750[CXXCBC-750]: **Internal Tracer for Wrapper SDKs** - Added internal tracer interface (`tracer_wrapper::wrapped()`) for use by wrapper SDKs that want to integrate with the SDK's tracing.
* https://jira.issues.couchbase.com/browse/CXXCBC-752[CXXCBC-752]: MapReduce Views are now deprecated. Use Query with SQL++ instead.
* https://jira.issues.couchbase.com/browse/CXXCBC-763[CXXCBC-763]: Fixed `set_authenticator` not applying updated cert/key pairs to new TLS sessions.
* https://jira.issues.couchbase.com/browse/CXXCBC-766[CXXCBC-766]: Fixed OpenSSL headers priority in BoringSSL builds.
* https://jira.issues.couchbase.com/browse/CXXCBC-767[CXXCBC-767]: Implemented AuthStale handling and JWT reauthentication support.
* https://jira.issues.couchbase.com/browse/CXXCBC-768[CXXCBC-768]: **DNS-SRV Refresh Fix** - Fixed an issue where `bucket_not_found` errors during bootstrap would trigger unnecessary DNS-SRV record refresh loops.
* https://jira.issues.couchbase.com/browse/CXXCBC-771[CXXCBC-771]: **Credentials Update Restrictions** - `cluster::update_credentials()` now prevents switching between authenticator types (e.g., password to certificate) to avoid unexpected behavior.
...
== Node.js SDK 4.6 Releases

=== Version 4.6.1 (20 February 2026)
...
=== Version 4.6.0 (29 September 2025)

Version 4.6.0 is the next minor release of the fourth generation Node.js SDK, bringing a number of improvements.
Most notably the 4.6.0 release adds support for Vector Search pre-filters.
...
For operations that allow an expiry to be specifed, using a Unix timestamp (e.g. `Math.floor(Date.now() / 1000) + 100 // 100 seconds`) as an absolute value is not supported.
If an absolute value is to be used, it should be `Date` object. Otherwise the expiry is interpreted as a number that represents the relative seconds from now.
...
* https://jira.issues.couchbase.com/browse/JSCBC-1329[JSCBC-1329]:
Added support "access_deleted" for replica reads.

* https://jira.issues.couchbase.com/browse/JSCBC-1330[JSCBC-1330]:
Updated supported bucket & storage types.

* https://jira.issues.couchbase.com/browse/JSCBC-1342[JSCBC-1342]:
Added support for Vector Search pre-filters.

* https://jira.issues.couchbase.com/browse/JSCBC-1353[JSCBC-1353]:
Updated operational SDK prevent connection to Analytics 2.0 Cluster.

* https://jira.issues.couchbase.com/browse/JSCBC-1354[JSCBC-1354]:
Updated bucket management tests to handle new `numVBuckets` setting.

* https://jira.issues.couchbase.com/browse/JSCBC-1358[JSCBC-1358]:
Updated SDK build setup to include {cpp} core changes.

* https://jira.issues.couchbase.com/browse/JSCBC-1359[JSCBC-1359]:
Added Graviton 3 and 4 executors to test pipeline matrices.

* https://jira.issues.couchbase.com/browse/JSCBC-1362[JSCBC-1362],
https://jira.issues.couchbase.com/browse/JSCBC-1363[JSCBC-1363]:
Added tracing, orphan and metrics configuration to `ConnectOptions`.

==== Fixes

* https://jira.issues.couchbase.com/browse/JSCBC-1357[JSCBC-1357]:
Fixed how client handles KV expiry.
...
=== Version 4.5.1 (29 September 2025)
...
* https://jira.issues.couchbase.com/browse/CXXCBC-693[CXXCBC-693]:
Do not return an error if/when `indexDefs` are empty/null. Instead return w/ an empty list of index definitions (https://github.com/couchbase/couchbase-cxx-client/pull/801[#801]).
...
Version 4.5.0 is the next minor release of the fourth generation Node.js SDK, bringing a number of improvements.
Most notably the 4.5.0 release adds support for transactional Zone Aware Replica Reads and transactional GetMulti.
...
* https://jira.issues.couchbase.com/browse/JSCBC-1273[JSCBC-1273]:
Added support for Node.js v22.

* https://jira.issues.couchbase.com/browse/JSCBC-1300[JSCBC-1300],
https://jira.issues.couchbase.com/browse/JSCBC-1324[JSCBC-1324]:
Added support for SDK Telemetry Collection in Server.

* https://jira.issues.couchbase.com/browse/JSCBC-1316[JSCBC-1316],
https://jira.issues.couchbase.com/browse/JSCBC-1317[JSCBC-1317]:
Added support for Transactional Zone Aware Read from Replica.

* https://jira.issues.couchbase.com/browse/JSCBC-1327[JSCBC-1327],
https://jira.issues.couchbase.com/browse/JSCBC-1347[JSCBC-1351]:
Added support for transactions ExtGetMulti (aka Enhanced Read Committed Isolation).

* https://jira.issues.couchbase.com/browse/JSCBC-1331[JSCBC-1331]:
Improved SDK error messages for account lock/unlock feature.

* https://jira.issues.couchbase.com/browse/JSCBC-1340[JSCBC-1340]:
Converted `retry_reasons` representation in error to human-readable strings.

* https://jira.issues.couchbase.com/browse/JSCBC-1343[JSCBC-1343]:
Fixed error context types to include missing fields specified in the RFC.

* https://jira.issues.couchbase.com/browse/JSCBC-1347[JSCBC-1347]:
Added experimental use of the Electron runtime.

==== Fixes

* https://jira.issues.couchbase.com/browse/JSCBC-1301[JSCBC-1301],
https://jira.issues.couchbase.com/browse/JSCBC-1303[JSCBC-1303],
https://jira.issues.couchbase.com/browse/JSCBC-1334[JSCBC-1334],
https://jira.issues.couchbase.com/browse/JSCBC-1339[JSCBC-1339]:
Fixed StreamablePromise API to allow the returned promise to be awaited after a delay.

* https://jira.issues.couchbase.com/browse/JSCBC-1322[JSCBC-1322],
https://jira.issues.couchbase.com/browse/JSCBC-1332[JSCBC-1332]:
Fixed subdoc operations from crashing if no specs are provided.

* https://jira.issues.couchbase.com/browse/JSCBC-1325[JSCBC-1325]:
Fixed prebuild script to allow space-delimited options.

* https://jira.issues.couchbase.com/browse/JSCBC-1333[JSCBC-1333]:
Fixed typo in ServerGroup test suite.

* https://jira.issues.couchbase.com/browse/JSCBC-1335[JSCBC-1335]:
CAS is no longer ignored for append/prepend operations.

* https://jira.issues.couchbase.com/browse/JSCBC-1341[JSCBC-1341]:
Console logger is now disabled when the file logger specified.

* https://jira.issues.couchbase.com/browse/JSCBC-1344[JSCBC-1344]:
Fixed collection management `createCollection` operation to omit `maxExpiry` if not set.

* https://jira.issues.couchbase.com/browse/JSCBC-1350[JSCBC-1350]:
Fixed transactional errors raised to application to be in line with the transactions RFC.
...
* https://jira.issues.couchbase.com/browse/JSCBC-1348[JSCBC-1348]:
Updated transaction errors to provide more information in error messages.
...
* https://jira.issues.couchbase.com/browse/JSCBC-1308[JSCBC-1308],
https://jira.issues.couchbase.com/browse/JSCBC-1309[JSCBC-1309],
https://jira.issues.couchbase.com/browse/JSCBC-1310[JSCBC-1310],
https://jira.issues.couchbase.com/browse/JSCBC-1313[JSCBC-1313],
https://jira.issues.couchbase.com/browse/JSCBC-1314[JSCBC-1314],
https://jira.issues.couchbase.com/browse/JSCBC-1315[JSCBC-1315]:
Added improvments to CI integration tests.

==== Fixes

* https://jira.issues.couchbase.com/browse/JSCBC-1258[JSCBC-1258]:
Fixed cluster string representation to prevent printing out username and password.

* https://jira.issues.couchbase.com/browse/JSCBC-1307[JSCBC-1307]:
Fixed SubDoc `MutateIn.decrement` to decrement instead of increment.

* https://jira.issues.couchbase.com/browse/JSCBC-1311[JSCBC-1311],
https://jira.issues.couchbase.com/browse/JSCBC-1312[JSCBC-1312]:
Fixed `PromiseHelper` utility to prevent uncaught exception.

* https://jira.issues.couchbase.com/browse/JSCBC-1318[JSCBC-1318]:
Fixed `LookupIn` replica methods to have correct option type and return type.
...
For operations that allow an expiry to be specifed, using a Unix timestamp (e.g. `Math.floor(Date.now() / 1000) + 100 // 100 seconds`) as an absolute value is not supported.
The expiry is interpreted as a number that represents the relative seconds from now.
