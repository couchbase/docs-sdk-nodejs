...
Updated transaction errors to provide more information in error message
...
https://jira.issues.couchbase.com/browse/CXXCBC-666[CXXCBC-666]: Fix pkg-config file (https://github.com/couchbase/couchbase-cxx-client/pull/736[#736])
https://jira.issues.couchbase.com/browse/CXXCBC-667[CXXCBC-667]: Core implementation of prepend/append should encode CAS value (https://github.com/couchbase/couchbase-cxx-client/pull/738[#738])
https://jira.issues.couchbase.com/browse/CXXCBC-671[CXXCBC-671]: update snappy to support CMake 4.0 (https://github.com/couchbase/couchbase-cxx-client/pull/745[#745])
