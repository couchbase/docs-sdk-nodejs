...
* https://jira.issues.couchbase.com/browse/CXXCBC-699[CXXCBC-699]:
Allow to randomize list of bootstrap nodes (https://github.com/couchbase/couchbase-cxx-client/pull/778[#778]).
...
* https://jira.issues.couchbase.com/browse/CXXCBC-715[CXXCBC-715]:
Fix intermittent crash during hard failover in HTTP connection manager (https://github.com/couchbase/couchbase-cxx-client/pull/817[[#817]).
