...
Fixed cluster string representation from printing out username and password
...
https://jira.issues.couchbase.com/browse/CXXCBC-638[CXXCBC-638]: switch to bundled fmtlib for spdlog (https://github.com/couchbase/couchbase-cxx-client/pull/710)[#710)], https://github.com/couchbase/couchbase-cxx-client/pull/705)[#705)])
https://jira.issues.couchbase.com/browse/CXXCBC-640[CXXCBC-640]: do not force debug symbols for release builds ( (https://github.com/couchbase/couchbase-cxx-client/pull/708)[#708)])

===== Fixes

https://jira.issues.couchbase.com/browse/CXXCBC-633[CXXCBC-633]: ensure DNS-SRV resolver reports timeouts ( (https://github.com/couchbase/couchbase-cxx-client/pull/703)[#703)])
