...
WARNING: Client Verified durability is supported in xref:3.2@durability-replication-failure-considerations.adoc#older-server-versions[Node.js SDK 3.2] but not in 4.0.
