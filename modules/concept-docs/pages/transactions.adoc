...
[source,typescript]
----
include::devguide:example$nodejs/transactions-example.ts[tag=create-simple,indent=0]
----
...
[source,typescript]
----
include::devguide:example$nodejs/transactions-example.ts[tag=rollback-cause,indent=0]
----
